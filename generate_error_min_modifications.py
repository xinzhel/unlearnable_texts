...
============================================
"""
def generate_mod(model_bundle, data_loader, test_data_loader, optimizer, mod_generator, mod_applicator,  num_train_steps_per_perturbation=30, task=None) -> Dict[str, float]:
    """
    Trains one epoch
    """
    ...
    for i, dataset_indices in enumerate(list_of_batch_indices):
        ...
        if batches_in_epoch_completed % num_train_steps_per_perturbation == 0:
            ...
            with open(f'{args.serialization_dir}/modifications_{batches_in_epoch_completed}.pickle', 'wb') as file:
...
if __name__=="__main__":
    ...
    all_modifications = generate_mod(model_bundle, data_loader, test_data_loader, optimizer, mod_generator, mod_applicator, args.num_train_steps_per_perturbation, task=args.task)
